...
import {
  UserItemFullResponseProps,
  UserItemResponseProps,
...
const updateItemUser = (
  item: UserItemFullResponseProps,
  arr: Array<UserItemResponseProps | UserItemFullResponseProps>
) => {
  let cpyArr = [...arr]
...
const ProductSlice = createSlice({
  ...
  extraReducers: builer => {
    builer.addCase(fetchListUserAsync.pending, () => {
      ...
      builer.addCase(
        fetchListUserAsync.fulfilled,
        (state, action: PayloadAction<userThunksActions>) => {
    ...
    builer.addCase(fetchListUserMoreAsync.pending, state => {
      ...
      builer.addCase(
        fetchListUserMoreAsync.fulfilled,
        (state, action: PayloadAction<userThunksActions>) => {
